...
// THis method is invoked in new.html. It shows tab-content, hides export-field, invokes select() when focused.
...
// This is called when the new-form .on('change") is invoked.
articleView.create = () => {
  let article;
  $('#articles').empty();
...
// Done: When is this function called? What event ultimately triggers its execution?
// This function is called on the new-form submit.It is triggered by a button click.
articleView.submit = event => {
  ...
  // This method is defiend in article.js. The event that triggers insertRecord is submit.
