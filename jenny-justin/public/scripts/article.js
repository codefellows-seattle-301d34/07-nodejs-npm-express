...
Article.prototype.insertRecord = function(callback) {
  $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
    .then(data => {
      ...
      // .then will not run at all if it fails. The if statement relies on the callback function to succeed, and then will continue with the rest of the function. Basically it waits for it to succeed before it continues. 
