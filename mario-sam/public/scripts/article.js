...
Article.prototype.insertRecord = function(callback) {
  $.post('/articles', {author: this.author, authorUrl: this.authorUrl, body: this.body, category: this.category, publishedOn: this.publishedOn, title: this.title})
    .then(data => {
      ...
      // The purpose of this is to make sure the callback function is called after talking to the server. In this case, there is no paramerter when insertRecord is invoked in articleView.js, therefore this callback is nothing and does not get invoked. It can be used to make our program more dynamic and add new features
